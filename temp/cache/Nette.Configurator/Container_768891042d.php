<?php
// source: /var/www/uloha-cortex/app/config/config.neon 
// source: /var/www/uloha-cortex/app/config/config.local.neon 

class Container_768891042d extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\Model\CardsManager' => array(1 => array('25_App_Model_CardsManager')),
			...
			'App\Presenters\UsersPresenter' => array(array('application.1')),
			'App\Presenters\HomepagePresenter' => array(array('application.2')),
			'App\Presenters\ErrorPresenter' => array(array('application.3')),
			'App\Presenters\RegistrationPresenter' => array(array('application.4')),
		...
		'services' => array(
			'25_App_Model_CardsManager' => 'App\Model\CardsManager',
			'26_App_Model_UserManager' => 'App\Model\UserManager',
			'application.1' => 'App\Presenters\UsersPresenter',
			'application.2' => 'App\Presenters\HomepagePresenter',
			'application.3' => 'App\Presenters\ErrorPresenter',
			'application.4' => 'App\Presenters\RegistrationPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/uloha-cortex/app',
			'wwwDir' => '/var/www/uloha-cortex/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/var/www/uloha-cortex/app/../temp',
		));
	}


	/**
	 * @return App\Model\CardsManager
	 */
	public function createService__25_App_Model_CardsManager()
	{
		$service = new App\Model\CardsManager($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new App\Presenters\UsersPresenter;
	...
	/**
	 * @return App\Presenters\RegistrationPresenter
	 */
	public function createServiceApplication__4()
	{
		$service = new App\Presenters\RegistrationPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->userManager = $this->getService('26_App_Model_UserManager');
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/var/www/uloha-cortex/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/uloha-cortex/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/uloha-cortex/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=mydb', 'root', 'dcw25ac', array('lazy' => TRUE));
	...
	{
		return new Container_768891042d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/var/www/uloha-cortex/app/../temp/cache/latte');
...
final class Container_768891042d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_768891042d $container)
	{
